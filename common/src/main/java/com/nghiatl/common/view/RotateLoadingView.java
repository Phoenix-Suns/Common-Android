...
public class RotateLoadingView extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (null != attrs) {
            ...
            mColor = typedArray.getColor(R.styleable.RotateLoadingView_loading_color, Color.WHITE);
            mWidth = typedArray.getDimensionPixelSize(R.styleable.RotateLoadingView_loading_width, dpToPx(context, DEFAULT_WIDTH));
