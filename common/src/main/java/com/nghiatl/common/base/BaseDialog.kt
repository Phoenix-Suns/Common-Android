...
abstract class BaseDialog(context: Context, lifecycle: Lifecycle?, themeRes: Int)
    ...
    constructor(fragment: Fragment) : this(fragment.context!!, fragment.lifecycle, 0)
    constructor(fragment: Fragment, themeRes: Int) : this(fragment.context!!, fragment.lifecycle, themeRes)
